...
<table width="100" border="0" align="center">
  <tr>
    <td align="center"><article class="boardArticle">
      <h3> 문의게시판 글쓰기</h3>
      ...
      <div id="boardWrite">
        <form action="./write_update.php" method="post">
          ...
          <table border="1" id="boardWrite">
            
            <body>
            <tr>
              <th bgcolor="#00FF99" scope="row"><label for="bID">아이디</label></th>
              <td class="id">
                <?php
								if(isset($bNo)) {
									echo $row['b_id'];
            ...
            <tr>
              <th bgcolor="#00FF99" scope="row"><label for="bTitle">제목</label></th>
              <td class="title"><input type="text" name="bTitle" id="bTitle" value="<?php echo isset($row['b_title'])?$row['b_title']:null?>"></td>
              </tr>
            <tr>
              <th bgcolor="#00FF99" scope="row"><label for="bContent">내용</label></th>
