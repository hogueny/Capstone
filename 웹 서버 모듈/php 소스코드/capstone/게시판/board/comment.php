...
<form action="comment_update.php" method="post">
  ...
  <tr>
    <td><p class="b">게시글 댓글 작성</p>
      <table border="1">
	    <tbody>
	      <tr>
	        <th bgcolor="#00FF99" class="a" style="color: #000" scope="row"><label for="coId">아이디</label></th>
	        <td><input type="text" name="coId" id="coId"></td>
	        </tr>
	      <tr>
	        <th bgcolor="#00FF99" class="a" style="color: #000" scope="row">
            <label for="coPassword">비밀번호</label></th>
	        <td><input type="password" name="coPassword" id="coPassword"></td>
	        </tr>
	      <tr>
	        <th bgcolor="#00FF99" class="a" style="color: #000" scope="row"><label for="coContent">내용</label></th>
