...
// book 테이블의 내용을 가져옴
$query = "select * from number where month(dt_create) like '%$mon%' and year(dt_create) like '%$year%'";
...
<table width ='1000'  align=center>
 <tr>
<td width '1000' align='center'><?php echo $_POST["year"],"년 ",$_POST["month"],"월 데이터입니다."; ?></td>
</tr>
</table>
...
<tr>
      <td width='50%' align='center' bgcolor='#00FF99'>날짜</td>
...
while($data=mysqli_fetch_array($result)) {
   echo"<tr>
		<td width='50%' align='center'>$data[dt_create]</td>
		<td width='50%' align='center'>$data[g_num]</td>
	</tr>";
