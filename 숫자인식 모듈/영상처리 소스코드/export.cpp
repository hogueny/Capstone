...
raspicam::RaspiCam Camera; //Cmaera object
    ...
    //save
    std::ofstream outFile ( "original.JPG",std::ios::binary );
    ...
    Mat image,imager, image2, image3, drawing;  //  Make images.
    ...
    image = imread("/home/pi/capstone/original.JPG");  //  Load an image file.
    
    cv::flip(image,imager,-1);

    imshow("Original", imager);
    waitKey(0);



    imager.copyTo(image2);  //  Copy to temporary images.
    imager.copyTo(image3);  //  'image2' - to preprocessing, 'image3' - to 'Snake' algorithm.
    ...
    imwrite("/home/pi/capstone/convert.JPG",
